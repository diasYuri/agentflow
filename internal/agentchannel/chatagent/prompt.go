...
func SystemPrompt() string {
	...
	b.WriteString("- If the user asks for the current state of a workflow run, use the workflow-status tool. If they want a fuller inspection, use the workflow-inspection tool.\n")
